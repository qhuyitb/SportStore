...
// sale controls
const slider = document.querySelector('.deal-products-container');
const leftArrow = document.querySelector('.left-arrow');
const rightArrow = document.querySelector('.right-arrow');
const scrollAmount = 300;

function updateArrows() {
    leftArrow.classList.toggle('disabled', slider.scrollLeft <= 5);
...
function openProductModal(productItem) {
  ...
  const soldCount = productItem.querySelector('.sold-count').textContent;
